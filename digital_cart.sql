...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 07, 2020 at 07:08 PM
...
INSERT INTO `cart_temp` (`slno`, `pid`, `quantity`, `amt`) VALUES
(1, '55', 1, 456);
...
(12, 30, '2020-02-10', 'regteyy', 'pending'),
(13, 30, '2020-03-07', 'hghj', 'hhhhh'),
(14, 23, '2020-03-07', 'kjhjj', 'pending'),
(15, 23, '2020-03-07', 'hahah', 'pending'),
(16, 23, '2020-03-07', 'ctftf', 'pending'),
(17, 23, '2020-03-07', 'ggg', 'pending');
...
('5q82io9ulpzxtdl5kgzgrl55q3teen2k', 'OGI4ZDJhMjcwYzEwNTQ4ZDNhNmZhODI0NmU2YjQ0YzYwZjZhZDA0NTp7ImFkbWluIjoyLCJycCI6ImZhdmljb24ifQ==', '2020-03-21 12:58:44.793262'),
('abf01vsux0v3nzrdwvpjeiv2cqlb4reu', 'OWRlMDVkZjMzMjhhMjliYTQ5MTA2ZjFiOTI4OTFkOGNlYTdmODIyMzp7ImxvZ2luIjoyLCJzaG9wIjo0LCJhZG1pbiI6Mn0=', '2020-03-21 10:59:17.555767'),
...
(17, 55, '2020-03-07', '2020-03-07 20:48:28.757001', 'qwe', '123'),
(18, 55, '2020-03-07', '2020-03-07 21:53:31.013643', 'bycash', '55');
...
INSERT INTO `product_details` (`productid`, `secid`, `productname`, `price`, `mfd date`, `exp date`) VALUES
...
(347, 25, 'qwerty', 100, '2020-01-01', '2025-09-09');
...
(4, 'qwerty', 'qwertyu', '876543', 'wer@tgftf'),
(6, 'hashim', 'rtjtj', '756764', 'jhg@ggg'),
(7, 'zxxcv', 'qwert', 'qwert', 'qwert'),
(8, 'aaaa', 'qwert', 'qwert', 'qwert'),
(9, '\ngsjjs', 'hsjdh', 'hsjdh', 'hsjdh'),
(10, 'gm', 'aaa', '456789', 'tyu'),
(11, 'jszjnz', 'ndnd', 'ndnd', 'ndnd');
...
--
ALTER TABLE `product_details`
  MODIFY `productid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=348;
...
--
ALTER TABLE `section`
  MODIFY `secid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
